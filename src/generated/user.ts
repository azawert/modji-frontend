 ...
 * Роль (определяет уровень доступа)
 */
export type NewUserDtoRole = typeof NewUserDtoRole[keyof typeof NewUserDtoRole];
...
export const getUserById = <TData = AxiosResponse<UserDto>>(
    ...
    return axios.default.get(
      `https://rodionov.ru.fvds.ru:443/users/${id}`,options
    );
  }
...
export const setUserState = <TData = AxiosResponse<UserDto>>(
    id: number,
    params: SetUserStateParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.default.patch(
      `https://rodionov.ru.fvds.ru:443/users/${id}/state`,undefined,{
    ...options,
        params: {...params, ...options?.params},}
    );
  }
