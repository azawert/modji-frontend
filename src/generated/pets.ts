 ...
 * Пол питомца
 */
export type UpdatePetDtoSex = typeof UpdatePetDtoSex[keyof typeof UpdatePetDtoSex];
...
export const addPet = <TData = AxiosResponse<PetDto>>(
    newPetDto: NewPetDto, options?: AxiosRequestConfig
 ): Promise<TData> => {
...
export const getPetById = <TData = AxiosResponse<PetDto>>(
    ...
    return axios.default.get(
      `https://rodionov.ru.fvds.ru:443/pets/${id}`,options
    );
  }
...
export const updatePet = <TData = AxiosResponse<PetDto>>(
    id: number,
    updatePetDto: UpdatePetDto, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.default.patch(
      `https://rodionov.ru.fvds.ru:443/pets/${id}`,
      updatePetDto,options
    );
  }
...
export const getPetsBySearch = <TData = AxiosResponse<PagePetDto>>(
    params?: GetPetsBySearchParams, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.default.get(
      `https://rodionov.ru.fvds.ru:443/pets/search`,{
    ...options,
