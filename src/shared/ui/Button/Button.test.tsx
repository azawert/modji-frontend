...
describe('Компонент кнопки', () => {
  ...
  it('Рендерит левую иконку', () => {
    render(
      <Button size={EButtonSize.Medium} variant={EButtonVariant.Primary} leftIcon="CategoryIcon">
        Button with Icon
      </Button>
    );
    expect(screen.getByText('Button with Icon').previousSibling).toBeInTheDocument();
  });

  it('Рендерит правую иконку', () => {
    render(
      <Button size={EButtonSize.Medium} variant={EButtonVariant.Primary} rightIcon="DeleteIcon">
        Button with Icon
      </Button>
    );
  ...
  it('Показывает спиннер при загрузке', () => {
    render(
      <Button size={EButtonSize.Medium} variant={EButtonVariant.Primary} isLoading>
        Loading Button
      </Button>
    );
  ...
  it('Отключена при пропе isDisabled', () => {
    render(
      <Button size={EButtonSize.Medium} variant={EButtonVariant.Primary} isDisabled>
        Disabled Button
      </Button>
    );
  ...
  it('Вызывает обработчик при клике', () => {
    ...
    render(
      <Button size={EButtonSize.Medium} variant={EButtonVariant.Primary} onClick={handleClick}>
        Clickable Button
      </Button>
    );
